      ...
      <div className="container">
        <div className="grid grid-cols-4 gap-6">
            ...
            <div className="w-full py-3">
                ...
                <ul className='mt-5 text-[#c7c7c7] lato_thin text-[16px] font-normal cursor-pointer'>
            ...
            <div className="w-full py-3 ">
                ...
                <div className="mt-5 text-center">
                    <input className='w-full h-[45px] pl-5 bg-inherit border border-gray-600 rounded-lg placeholder:text-[#f7f7f7] text-white cursor-pointer' type="text" placeholder='Enter your email' />
                    <button className='px-[50px] py-3 bg-gray-600 lato_thin text-[18px] text-[#f7f7f7] font-medium mt-5 rounded-xl cursor-pointer' type='button'>Subscribe</button>
                </div>
            </div>
        </div>
      </div>
