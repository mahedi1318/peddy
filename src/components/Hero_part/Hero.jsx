      ...
      <div className='h-[900px]'>
        <div className="container">
            <div className='text-center'>
                ...
                <h1 className='lato_thin font-black md:text-[72px] text-[34px] md:w-[750px] w-[255px] m-auto leading-tight mt-5'>Your Path to Adoption Starts Here</h1>
                <p className='lato_thin font-normal text-[16px] w-[243px] md:w-[734px] m-auto leading-7 mt-5 text-[#131313]'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
